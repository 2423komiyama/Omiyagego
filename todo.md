...
## 名古屋・静岡PoC対応（2026-03-30）
- [x] 現在のDB状況調査（名古屋駅114件・静岡駅138件の売り場データ確認）
- [x] 名古屋エリア施設マスターデータ充実化（名古屋駅・セントレア・栄・名鉄名古屋・金山完了）
- [x] 静岡エリア施設マスターデータ充実化（静岡駅・浜松駅・新富士駅・三島駅完了）
- [x] 名古屋エリアお土産商品データ充実化（名古屋駅67商品・セントレア8商品完了）
- [x] 静岡エリアお土産商品データ充実化（静岡駅45商品・浜松駅3商品完了）
- [x] StationPageのFACILITY_METAに名古屋・静岡エリア全施設を追加（セントレア・栄・浜松・新富士・三島）
- [x] routers.tsのFACILITY_ID_MAPに名古屋・静岡エリア全施設を追加
- [x] mockData.tsのFacilityId型・FACILITIES配列に名古屋・静岡エリアを追加
- [x] プッシュ通知の位置情報判定（Haversine計算）が名古屋・静岡施設座標で正常動作することを確認
- [x] テスト38/38パス・チェックポイント保存
- [ ] プッシュ通知・検索・施設ページの動作確認
- [ ] テスト・チェックポイント保存
